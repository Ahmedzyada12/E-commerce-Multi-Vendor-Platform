...
@section('main')
    ...
    @if (Session::has('status'))
        <p class="alert
     {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('status') }}</p>
    @endif
...
`
            ...
            <div class="col-md-6 <?= $align ?> ">
                <div class="page-title p-2 bg-light">
                    <h6 class="d-inline-block">{{ __('customTranslate.Home') }} / {{ __('customTranslate.Shop') }} /
                        {{ $product->name }}</h6>
                </div>

                <div class="main-details mt-3 ">
                    <h6> {{ $product->name }}</h6>
                    <div class="reviews mt-2 d-flex ">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2" >
                        ...
                        @foreach ($product->tag as $tag)
                            <h6 class="py-1 px-2 text-light text-none "
                                style="display:inline-flex;  background-color:#00b9ff; border-radius: 10px ">{{ $tag->name }}</h6>
                        @endforeach
                    </div>
                        ...
                        <div class="row mt-5 gy-4">
                            ...
                            @else
                                @if ($product->sizes->isNotEmpty())
                                    <div class="col-lg-6">
                                        <select class="form-select w-full" name="product_size"
                            ...
                            <div class="col-lg-6">
                                <select class=" form-select " name="product_color" aria-label=".form-select-lg example">
                            ...
                            <div class="container text-center">
                                <div class="row d-flex align-items-center">
                                    <div class="handle-quantity col-lg-6 d-flex ">
                                        ...
                                        <input type="hidden" name="vendor_id" value="{{ $product->category_id }}">
                                        ...
                                        Seller"
                                                ...
                                                <div class="sc-ba64d01c-2 hpjkeA">
                                                    <div class="sc-ba64d01c-3 bZXrTi"><img
                                                            ...
                                                            alt="Cash on 
                                        Delivery"
                                                            class="sc-d13a0e88-1 cMrpQt"></div><span>Cash on
                                                        Delivery</span>
                                                </div>
                                                <div class="sc-ba64d01c-4 bTuvqR"></div>
                                                <div class="sc-ba64d01c-2 hpjkeA">
