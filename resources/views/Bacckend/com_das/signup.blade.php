                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    ...
                                    <div class="main-signup-header">
                                        ...
                                        <form class="form-input login user-wrapper active" method="POST"
                                            action="{{ route('manger_register') }}">
                                            @csrf
                                            <div class="form-group">
                                                <label>Firstname &amp; Lastname</label> <input class="form-control"
                                                    placeholder="Enter your firstname and lastname" name="name"
                                                    type="text">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            </div><button class="btn btn-main-primary btn-block" type="submit">Create
                                                Account</button>
                                        </form>
                                    </div>
                                </div>
